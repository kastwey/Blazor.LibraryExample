...
namespace EpubReader.Library.Readers
{
	...
	{
		public static async Task<EpubNavigation> ReadNavigationAsync(ZipFile epubArchive, string contentDirectoryPath, EpubPackage package)
		{
			...
			ZipEntry tocFileEntry = epubArchive.GetEntry(tocFileEntryPath);
