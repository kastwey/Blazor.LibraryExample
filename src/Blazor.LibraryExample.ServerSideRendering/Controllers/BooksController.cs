namespace Blazor.LibraryExample.ServerSideRendering.Controllers
{
	...
	public class BooksController : Controller
	{
		...
		/// <summary>
		/// Reads the sample book.
		/// </summary>
		/// <returns>The file content with the sample epub.</returns>
		[HttpGet("ReadSampleBook")]
		public IActionResult ReadSampleBook()
		{
